...
const CardLayout = ({ selectedCity = "London" }) => {
  ...
  const defaultLink = "/deals"; // 👈 change this if needed
  ...
  return (
    <div className="px-4 sm:px-6 md:px-12 lg:px-20 my-8">
      ...
      <div className="mt-6 flex items-center gap-3">
        ...
        <div className="border px-6 h-14 flex items-center justify-center hover:bg-amber-500">
          <a href={defaultLink} className="text-md">
            View More Deals
          </a>
        </div>
